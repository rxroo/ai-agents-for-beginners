...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T16:38:54+00:00",
  "source_file": "README.md",
  "language_code": "fa"
}
-->
# دوره‌ای برای مبتدیان در مورد عوامل هوش مصنوعی
...
اگر این اولین بار است که با مدل‌های هوش مصنوعی مولد کار می‌کنید، دوره [هوش مصنوعی مولد برای مبتدیان](https://aka.ms/genai-beginners) ما را بررسی کنید که شامل ۲۱ درس در مورد ساخت با GenAI است.
...
اگر گیر کردید یا سوالی در مورد ساخت عوامل هوش مصنوعی دارید، به کانال اختصاصی Discord ما در [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord) بپیوندید.

### آنچه نیاز دارید

هر درس در این دوره شامل نمونه‌های کدی است که در پوشه code_samples قرار دارد. می‌توانید [این مخزن را فورک کنید](https://github.com/microsoft/ai-agents-for-beginners/fork) تا نسخه خودتان را ایجاد کنید.
...
- یک درس نوشتاری در README و یک ویدیوی کوتاه  
