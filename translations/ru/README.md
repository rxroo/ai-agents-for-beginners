...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T16:34:17+00:00",
...
Для этого курса доступна поддержка нескольких языков. Перейдите к [доступным языкам здесь](../..). 
...
Если вы столкнулись с трудностями или у вас есть вопросы о создании AI-агентов, присоединяйтесь к нашему специальному каналу Discord в [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
|----------------------------------------------|--------------------------------------------------|------------------------------------------------------------|----------------------------------------------------------------------------------------|
| Введение в AI-агенты и их случаи использования | [Ссылка](./01-intro-to-ai-agents/README.md)      | [Видео](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [Ссылка](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Создание агентов для работы с компьютером (CUA) | Скоро                            |                                                            |                                                                                        |
...
Спасибо [Шиваму Гоялу](https://www.linkedin.com/in/shivam2003/) за предоставление важных примеров кода, демонстрирующих Agentic RAG. 
...
права на использование вашего вклада. Подробности можно найти на <https://cla.opensource.microsoft.com>.

Когда вы отправляете pull request, бот CLA автоматически определит, нужно ли вам предоставить
CLA, и добавит соответствующую отметку (например, проверка статуса, комментарий). Просто следуйте инструкциям,
...
должно соответствовать и следовать
