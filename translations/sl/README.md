...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T18:26:27+00:00",
...
[![GitHub sodelujoči](https://img.shields.io/github/contributors/microsoft/ai-agents-for-beginners.svg)](https://GitHub.com/microsoft/ai-agents-for-beginners/graphs/contributors/?WT.mc_id=academic-105485-koreyst)  
...
Ne pozabite [označiti z zvezdico (🌟) ta repozitorij](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) in [ustvariti vilico tega repozitorija](https://github.com/microsoft/ai-agents-for-beginners/fork), da zaženete kodo.

### Spoznajte druge učence, dobite odgovore na svoja vprašanja

Če se zataknete ali imate kakršna koli vprašanja o gradnji AI agentov, se pridružite našemu namenskem kanalu Discord v [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
| Raziskovanje Microsoftovega agentnega ogrodja                         | [Povezava](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
