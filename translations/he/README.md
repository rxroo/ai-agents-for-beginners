...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:50:23+00:00",
...
## קורס שמלמד את כל מה שצריך לדעת כדי להתחיל לבנות סוכני AI
...
בקורס זה יש שיעורים המכסים את היסודות של בניית סוכני AI. כל שיעור מתמקד בנושא משלו, כך שתוכלו להתחיל בכל מקום שתרצו!

יש תמיכה בריבוי שפות לקורס זה. עברו ל-[שפות הזמינות כאן](../..).  

אם זו הפעם הראשונה שלכם בבנייה עם מודלים של AI גנרטיבי, בדקו את הקורס שלנו [Generative AI For Beginners](https://aka.ms/genai-beginners), הכולל 21 שיעורים על בנייה עם GenAI.

אל תשכחו [לסמן בכוכב (🌟) את הריפו הזה](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) ו-[ליצור מזלג לריפו הזה](https://github.com/microsoft/ai-agents-for-beginners/fork) כדי להריץ את הקוד.

### הכירו לומדים אחרים, קבלו תשובות לשאלות שלכם

אם אתם נתקעים או יש לכם שאלות על בניית סוכני AI, הצטרפו לערוץ הדיסקורד הייעודי שלנו ב-[Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### מה תצטרכו

כל שיעור בקורס זה כולל דוגמאות קוד, שניתן למצוא בתיקיית code_samples. תוכלו [ליצור מזלג לריפו הזה](https://github.com/microsoft/ai-agents-for-beginners/fork) כדי ליצור עותק משלכם.  

דוגמאות הקוד בתרגילים אלו משתמשות ב-Azure AI Foundry ובקטלוגי מודלים של GitHub לאינטראקציה עם מודלים לשוניים:
...
הקורס משתמש גם במסגרת סוכני AI ושירותים הבאים של Microsoft:
...
| תבנית עיצוב מרובת סוכנים                    | [קישור](./08-multi-agent/README.md)                 | [וידאו](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [קישור](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
תודה ל-[שיבאם גוייאל](https://www.linkedin.com/in/shivam2003/) על תרומתו עם דוגמאות קוד חשובות המדגימות Agentic RAG. 
...
כאשר אתה מגיש בקשת pull, בוט CLA יקבע באופן אוטומטי אם עליך לספק CLA ויעטר את ה-PR בהתאם (לדוגמה, בדיקת סטטוס, תגובה). פשוט עקוב אחר ההוראות שסופקו על ידי הבוט. תצטרך לעשות זאת רק פעם אחת בכל המאגרים המשתמשים ב-CLA שלנו.
