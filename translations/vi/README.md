...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T17:53:11+00:00",
...
**Nếu bạn muốn có thêm ngôn ngữ hỗ trợ, danh sách các ngôn ngữ được hỗ trợ có thể được tìm thấy [tại đây](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Nếu bạn gặp khó khăn hoặc có bất kỳ câu hỏi nào về việc xây dựng AI Agents, hãy tham gia kênh Discord chuyên dụng của chúng tôi trong [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).
...
Để biết thêm thông tin về cách chạy mã cho khóa học này, hãy truy cập [Course Setup](./00-course-setup/README.md).
...
| Khám phá Khung Tác Nhân Microsoft                         | [Liên kết](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
...
Dự án này có thể chứa các thương hiệu hoặc logo cho các dự án, sản phẩm hoặc dịch vụ. Việc sử dụng hợp pháp các thương hiệu hoặc logo của Microsoft phải tuân theo và tuân thủ [Hướng Dẫn Thương Hiệu & Nhãn Hiệu của Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).  
