...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T16:57:35+00:00",
...
## एक कोर्स जो आपको एआई एजेंट्स बनाना शुरू करने के लिए सब कुछ सिखाता है
...
यह कोर्स एआई एजेंट्स बनाने की मूलभूत बातों को कवर करता है। हर पाठ एक अलग विषय को कवर करता है, तो आप कहीं से भी शुरू कर सकते हैं!

इस कोर्स में बहुभाषी समर्थन है। हमारे [उपलब्ध भाषाओं](../..) पर जाएं।  

यदि यह आपका पहली बार जनरेटिव एआई मॉडल्स के साथ काम करना है, तो हमारे [शुरुआती लोगों के लिए जनरेटिव एआई](https://aka.ms/genai-beginners) कोर्स को देखें, जिसमें जनरेटिव एआई के साथ काम करने के 21 पाठ शामिल हैं।
...
यदि आप कहीं अटक जाते हैं या एआई एजेंट्स बनाने के बारे में कोई सवाल है, तो हमारे [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord) चैनल में शामिल हों।

### आपको क्या चाहिए

इस कोर्स के हर पाठ में कोड उदाहरण शामिल हैं, जो code_samples फोल्डर में पाए जा सकते हैं। आप [इस रिपॉजिटरी को फोर्क करें](https://github.com/microsoft/ai-agents-for-beginners/fork) ताकि आप अपनी खुद की कॉपी बना सकें।  
...
यह कोर्स Microsoft के निम्नलिखित एआई एजेंट फ्रेमवर्क और सेवाओं का भी उपयोग करता है:
...
| स्केलेबल एजेंट्स को डिप्लॉय करना                    | जल्द आ रहा है                            |                                                            |                                                                                        |
| लोकल एआई एजेंट्स बनाना                     | जल्द आ रहा है                               |                                                            |                                                                                        |
...
[![शुरुआती के लिए वेब डेव](https://img.shields.io/badge/Web%20Dev%20for%20Beginners-EC4899?style=for-the-badge&labelColor=E5E7EB&color=EC4899)](https://aka.ms/webdev-beginners?WT.mc_id=academic-105485-koreyst)
...
एजेंटिक RAG कोड सैंपल्स दिखाने के लिए [शिवम गोयल](https://www.linkedin.com/in/shivam2003/) का धन्यवाद। 

## योगदान

यह प्रोजेक्ट योगदान और सुझावों का स्वागत करता है। अधिकांश योगदानों के लिए आपको एक 
Contributor License Agreement (CLA) पर सहमति देनी होगी, जिसमें यह घोषित करना होगा कि आपके पास योगदान का अधिकार है और आप हमें इसका उपयोग करने का अधिकार देते हैं। अधिक जानकारी के लिए देखें <https://cla.opensource.microsoft.com>।

जब आप एक पुल रिक्वेस्ट सबमिट करते हैं, तो एक CLA बॉट स्वचालित रूप से यह निर्धारित करेगा कि आपको CLA प्रदान करने की आवश्यकता है या नहीं और PR को उपयुक्त रूप से सजाएगा (जैसे, स्टेटस चेक, टिप्पणी)। बस बॉट द्वारा दिए गए निर्देशों का पालन करें। आपको यह केवल एक बार सभी रिपोज़िटरीज़ के लिए करना होगा जो हमारे CLA का उपयोग करते हैं।
...
इस प्रोजेक्ट में प्रोजेक्ट्स, प्रोडक्ट्स, या सेवाओं के लिए ट्रेडमार्क्स या लोगो हो सकते हैं। Microsoft ट्रेडमार्क्स या लोगो के अधिकृत उपयोग को 
...
यदि आपको प्रोडक्ट फीडबैक देना है या निर्माण के दौरान त्रुटियां आती हैं, तो यहां जाएं:
