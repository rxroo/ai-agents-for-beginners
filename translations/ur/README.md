...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-11-18T16:41:18+00:00",
  "source_file": "README.md",
  "language_code": "ur"
}
-->
# ابتدائیوں کے لیے اے آئی ایجنٹس - ایک کورس
...
اگر یہ آپ کا پہلا موقع ہے جنریٹیو اے آئی ماڈلز کے ساتھ کام کرنے کا، تو ہمارا [ابتدائیوں کے لیے جنریٹیو اے آئی](https://aka.ms/genai-beginners) کورس دیکھیں، جس میں جنریٹیو اے آئی کے ساتھ کام کرنے کے 21 اسباق شامل ہیں۔

یہ نہ بھولیں کہ [اس ریپو کو اسٹار (🌟) کریں](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) اور [اسے فورک کریں](https://github.com/microsoft/ai-agents-for-beginners/fork) تاکہ کوڈ چلا سکیں۔

### دیگر سیکھنے والوں سے ملیں، اپنے سوالات کے جوابات حاصل کریں

اگر آپ کو کسی مسئلے کا سامنا ہو یا اے آئی ایجنٹس بنانے کے بارے میں کوئی سوال ہو، تو ہمارے مخصوص ڈسکارڈ چینل میں شامل ہوں [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord)۔
...
- Python کوڈ کے نمونے Azure AI Foundry اور GitHub ماڈلز (مفت) کے ساتھ  
...
|-------------------------------------------|----------------------------------------------------|------------------------------------------------------------|-------------------------------------------------------------------------------------|
| اے آئی ایجنٹس اور ایجنٹ کے استعمال کے معاملات کا تعارف | [لنک](./01-intro-to-ai-agents/README.md)          | [ویڈیو](https://youtu.be/3zgm60bXmQk?si=z8QygFvYQv-9WtO1)  | [لنک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| اے آئی ایجنٹک فریم ورکز کی تلاش            | [لنک](./02-explore-agentic-frameworks/README.md)  | [ویڈیو](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [لنک](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
[opencode@microsoft.com](mailto:opencode@microsoft.com) پر کسی بھی اضافی سوالات یا تبصروں کے لیے رابطہ کریں۔
